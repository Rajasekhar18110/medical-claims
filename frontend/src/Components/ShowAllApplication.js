...
function ShowAllApplication() {
    ...
    const getData = async () => {
        ...
        const res = await fetch(
            "https://medical-claims2.herokuapp.com/showallApplicationId/" + id,
            {
                method: "POST",
    ...
    const updateStatus_A = async (e) => {
        ...
        const res = await fetch(
            "https://medical-claims2.herokuapp.com/updateStatus",
            {
                method: "POST",
    ...
    const getRemarks = async () => {
        authorityUser["email"] = currentUser.email
        const res = await fetch(
            "https://medical-claims2.herokuapp.com/getRemarks/" + id,
            {
                method: "POST",
                body: JSON.stringify({ authorityUser }),
                headers: { "content-Type": "application/json" },
    ...
    const getdata_from_accountsectiontable = async () => {
        const email = currentUser.email
        const res = await fetch(
            "https://medical-claims2.herokuapp.com/getData_from_accounttable/" +
                id,
            {
                method: "POST",
    ...
    const saveit = async (e) => {
        ...
        if (!user.total2 || !user.rupnum || !user.rupword) {
            ...
            const res = await fetch(
                "https://medical-claims2.herokuapp.com/update_data_from_accountsection",
                {
                    method: "POST",
                    body: JSON.stringify({ user }),
                    headers: { "Content-Type": "application/json" },
                        ...
                        <Row>
                            <Col>
                                <Form.Text id="passwordHelpBlock" muted>
                                    Note: In case of any clarification click on
                                    hold and please let the applicant know by
                                    contacting him
                                </Form.Text>
                                <Form.Control
                                    style={{ width: "700px" }}
                                    ...
                                    defaultValue={
                                        authorityUser["current_auth_remarks"]
                                    }
                                    onChange={(e) =>
                                        setauthorityUser({
                                            ...authorityUser,
