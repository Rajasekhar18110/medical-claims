...
function ShowApplication() {
    ...
    const getData = async () => {
        ...
        const res = await fetch(
            "https://medical-claims2.herokuapp.com/showApplicationId/" + id,
            {
                method: "POST",
    ...
    const getStatus = async () => {
        const res2 = await fetch(
            "https://medical-claims2.herokuapp.com/showApplicationIdStatus/" +
                id,
            {
                method: "POST",
                body: JSON.stringify({ user_data }),
    ...
    const resubmit_application = async (e) => {
        ...
        if (
            ...
            const res4 = await fetch(
                "https://medical-claims2.herokuapp.com/resubmitApplication",
                {
                    method: "POST",
                    body: JSON.stringify({
                        ...new_obj,
